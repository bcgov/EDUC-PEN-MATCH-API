...
/**
 * The type Pen match request interceptor.
 */
@Component
public class PenMatchRequestInterceptor implements AsyncHandlerInterceptor {

  /**
   * The constant log.
   */
  private static final Logger log = LoggerFactory.getLogger(PenMatchRequestInterceptor.class);
